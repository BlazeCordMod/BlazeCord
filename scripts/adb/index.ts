...
import { type BlazeCordBuildContext, createBuildContext } from "../build";
...
async function handleRebuild(serialNumber: string, buildContext: BlazeCordBuildContext, port: number) {
    if (buildContext) {
