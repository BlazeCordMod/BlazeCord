...
import { createBuildContext, type BlazeCordBuildContext } from "../build";
...
export function startDevelopmentServer(
    getBuildContext: () => Promise<BlazeCordBuildContext>,
    getMinifiedBuildContext: () => Promise<BlazeCordBuildContext>,
) {
...
if (import.meta.main) {
    ...
    let buildContext: BlazeCordBuildContext;
    let minifiedBuildContext: BlazeCordBuildContext;
