import type { BlazeCordTheme } from "@plugins/_core/painter/types";
...
const themeCollectionManager = createAddonCollectionManager<BlazeCordTheme, "A-Z" | "Z-A", string>({
