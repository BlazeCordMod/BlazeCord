...
export namespace Metro {
    ...
    export interface ModuleDefinition {
        ...
        hot?: HotModuleReloadingData | undefined;
        /**
         * Cached `import *` imports in Metro, always an empty object as blaze prevents outdated import cache
         * */
        importedAll: any;
        /**
         * Cached `import module from "./module"` imports in Metro, always an empty object as blaze prevents outdated import cache
         * */
        importedDefault: any;
        /**
