...
export interface BlazeCordPluginDefinition<D extends DefinedOptions<O>, O extends OptionDefinitions> {
...
export type BlazeCordPluginInstance<
    O extends OptionDefinitions = OptionDefinitions,
    D extends DefinedOptions<O> = DefinedOptions<O>,
> = SetRequired<BlazeCordPluginDefinition<D, O>, `$${RequiredRuntimePropertyKey}`> & InternalRuntimeMethods;

export type LooseBlazeCordPlugin<P> = WithThis<P, BlazeCordPluginInstance>;
