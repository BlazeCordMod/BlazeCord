...
export function registerPlugin<
    P extends BlazeCordPluginDefinition<D, O>,
    D extends DefinedOptions<O>,
    O extends OptionDefinitions,
>(id: string, plugin: BlazeCordPluginInstance<O>): (relativePath: string) => P {
...
export function isPluginInternal(plugin: BlazeCordPluginInstance) {
