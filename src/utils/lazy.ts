...
interface LazyOptions<E extends ExemptedEntries> {
     ...
     * Alternatively, you can access the original function by using the hidden property `Symbol.for("blazecord.lazy.originalFn")` on the bound function.
     */
...
const originalFnSym = Symbol.for("blazecord.lazy.originalFn");
